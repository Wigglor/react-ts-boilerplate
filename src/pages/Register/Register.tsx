...
const Register = (): ReactElement => {
  ...
  const handleGoogleLogin = () => {
    // const authUrl = `https://accounts.google.com/o/oauth2/v2/auth?client_id=523632201518-emi1ioba9vvudkc2u8on28gph5cc2cu0.apps.googleusercontent.com&response_type=code&scope=openid+email+profile&redirect_uri=http://localhost:8080/socialcallback&prompt=select_account`;
    const authUrl = `https://test-2023-10.auth.eu-north-1.amazoncognito.com/oauth2/authorize?prompt=select_account&response_type=code&client_id=3drrlf4iharl544lebn61viqdm&identity_provider=Google&redirect_uri=http://localhost:8080/socialcallback&state=STATE&scope=openid+profile+aws.cognito.signin.user.admin`;
