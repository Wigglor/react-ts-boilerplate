  ...
  return (
    <>
      <main className="relative min-h-full">
        <body className="mb-[40px] sm:mb-[64px] bg-gray-50 dark:bg-neutral-950">
                  ...
                  <ul>
                    ...
                    <li className="hs-accordion px-5 mb-1.5 " id="users-accordion">
                      ...
                      >
                        ...
                        Users
                        <svg
                          className="hs-accordion-active:-rotate-180 flex-shrink-0 mt-1 w-3.5 h-3.5 ms-auto transition"
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                          height="24"
                          viewBox="0 0 24 24"
                    ...
                    <li className="pt-5 px-8 mt-5 mb-1.5 border-t border-gray-200 first:border-transparent first:pt-0 dark:border-neutral-700 dark:first:border-transparent"></li>
                  </ul>
                </nav>
              </div>
          ...
          {/* <main id="content" role="main" className="lg:ps-[260px] pt-[59px]">
            <div className="p-2 sm:p-5 sm:pb-0 md:pt-5 space-y-5">
              <div className="p-4 flex flex-col justify-center h-72 md:h-96 min-h-[calc(100vh-115px)] sm:min-h-[calc(100vh-143px)] bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
      ...
      {/* <main>
        ...
        <main id="content" role="main" className="lg:ps-[260px] pt-[59px] lg:pt-0">
